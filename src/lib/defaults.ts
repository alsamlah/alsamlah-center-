    ...
    zones: [
      {
        ...
        items: [
          ...Array.from({ length: 10 }, (_, i) => ({
            id: `room-${i + 1}`,
            name: `غرفة ${i + 1}`,
            sub: i === 9 ? "PS5 / مباراة" : "PS5",
          })),
          // Former floor sessions become rooms 11 and 12 (IDs kept for history)
          { id: "floor-1", name: "غرفة 11", sub: "PS5 + TV" },
          { id: "floor-2", name: "غرفة 12", sub: "PS5 + TV" },
        ],
      },
      {
        id: "billiard1",
        ...
        pricePerHour: 25,
        minCharge: 30,
        priceTiers: TENNIS_BILLIARD_TIERS,
        pricingMode: "tiered",
        items: [
          { id: "bill1-1", name: "بلياردو 1" },
          { id: "bill1-2", name: "بلياردو 2" },
          { id: "bill1-3", name: "بلياردو 3" },
          // Former floor 2 billiard tables, renumbered 4 and 5
          { id: "bill2-1", name: "بلياردو 4" },
          { id: "bill2-2", name: "بلياردو 5" },
        ],
      },
      {
        id: "chess",
        ...
        pricePerHour: 20,
        minCharge: 30,
        priceTiers: CHESS_TIERS,
        pricingMode: "tiered",
        items: Array.from({ length: 2 }, (_, i) => ({ id: `chess-${i + 1}`, name: `شطرنج ${i + 1}` })),
      },
      {
        id: "baloot1",
        name: "بلوت",
      ...
      },
      {
        ...
        priceTiers: TENNIS_BILLIARD_TIERS,
        pricingMode: "tiered",
        items: Array.from({ length: 4 }, (_, i) => ({ id: `tennis-${i + 1}`, name: `تنس ${i + 1}` })),
      },
      {
        id: "boxing",
        name: "بوكسينج",
        ...
        pricingMode: "token",
        hitPrice: 7.5,
        items: [{ id: "boxing-1", name: "بوكسينج" }],
      },
      {
        id: MASSAGE_ZONE_ID,
        name: "مساج",
        ...
        pricingMode: "manual",
        items: [
          { id: "massage-1", name: "كرسي مساج 1" },
          { id: "massage-2", name: "كرسي مساج 2" },
        ],
      },
    ],
  },
